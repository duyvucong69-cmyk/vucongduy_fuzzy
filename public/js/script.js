...
dirSwitch?.addEventListener("change", (e) => {
  ...
  if (!checkbox.checked) {
    ...
    rtlLink.href = "/css/vendors/bootstrap.min.css";
    localStorage.setItem("rtlcss", "/css/vendors/bootstrap.min.css");
    localStorage.setItem("dir", "ltr");
  }
});
// Rtl
let savedRtlCss = localStorage.getItem("rtlcss");
if (savedRtlCss && savedRtlCss.startsWith("assets/")) {
  savedRtlCss = "/" + savedRtlCss.substring(7);
  localStorage.setItem("rtlcss", savedRtlCss);
}
htmlDom.setAttribute("dir", localStorage.getItem("dir") ? localStorage.getItem("dir") : "ltr");
rtlLink.href = savedRtlCss ? savedRtlCss : "/css/vendors/bootstrap.min.css";
